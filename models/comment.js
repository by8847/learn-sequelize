...
class Comment extends Sequelize.Model {
    ...
    static initiate(sequelize) {
        ...
        Comment.init({
            ...
            carset: 'utf8mb4', // 문자셋을 UTF-8MB4(4바이트 유니코드 / 기본문자 + 특수기호 + 이모티콘으로 구성)로 지정
            collate: 'utf8mb4_general_ci' // 콜레이션을 UTF-8MB4_GENERAL_CI로 지정
                                            // 코레이션 -> 데이터베이스에서 문자열을 비교하고 정렬하는 데 사용되는 규칙이 세트
        ...
        static associate(db) {
            ...
            db.Comment.belongsTo(db.User, { foreignKey: 'commneter', targetKey: 'id' });
        }
    };
